  ...
  return (
    <div id="getInTouch">
      ...
      <ul id="icons02" className="style1 icons">
        <li>
          <a className="n01" href="https://www.linkedin.com/in/vin%C3%ADcius-perazza-9375b1188/">
            <svg
        ...
        <li>
          <a className="n02" href="https://github.com/Perazza">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="1"
              height="1"
        ...
        <li>
          <a className="n03" href="https://www.kaggle.com/perazza">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="1"
              height="1"
      ...
      <hr />
      <ul id="buttons02" className="style3 buttons">
        <li>
          <a href="#" className="button n01">
            <span className="label">To the top!</span>
          </a>
        </li>
      </ul>
    </div>
